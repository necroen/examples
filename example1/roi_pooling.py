...
def roi_pooling(feats, rois , spatial_scale_H, spatial_scale_W, size=(7, 7)):
    assert(rois.dim() == 2)    
...
#    rois[:, 1:].mul_(spatial_scale)
    rois[:, 1].mul_(spatial_scale_W)
    rois[:, 3].mul_(spatial_scale_W)
    rois[:, 2].mul_(spatial_scale_H)
    rois[:, 4].mul_(spatial_scale_H)
